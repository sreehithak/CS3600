# qlearningAgents.py͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
# ------------------͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        "*** YOUR CODE HERE ***"
        self.qs = util.Counter() # A Counter is a dict with default 0
    ...
    def getQValue(self, state, action):
        ...
        """
        "*** YOUR CODE HERE ***"
        if (state, action) not in self.qs:
            return 0.0
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        "*** YOUR CODE HERE ***"
        x = reward + self.discount * self.computeValueFromQValues(nextState)
        self.qs[(state, action)] =  self.getQValue(state, action) * (1 - self.alpha) + self.alpha * x
        #util.raiseNotDefined()
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def final(self, state):
        ...
        # call the super-class final method͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
        PacmanQAgent.final(self, state)

        # did we finish training?͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
        if self.episodesSoFar == self.numTraining:
            # you might want to print your weights here for debugging͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
            "*** YOUR CODE HERE ***"
            pass