...
class InferenceModule:
    ...
    """
    ############################################
    # Useful methods for all inference modules #͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
    ############################################
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        #raiseNotDefined()͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
    ...
    ######################################
    # Methods that need to be overridden #͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
    ######################################
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for x in self.allPositions:
            observed = self.getObservationProb(observation, pacmanposition, x, jailPosition)
            self.beliefs[x] = self.beliefs[x] * observed
        self.beliefs.normalize()
        #raiseNotDefined()
    ...
    def elapseTime(self, gameState):
        ...
        for gPos in self.allPositions:
            ...
            for oldPos in self.allPositions:
                newPosDist = self.getPositionDistribution(gameState, oldPos)
                p += self.beliefs[oldPos] * newPosDist[gPos]
            newBeliefs[gPos] = p
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        for i in range(particles):
            self.particles.append(legal[i % numLegal])
        #raiseNotDefined()
...
class JointParticleFilter(ParticleFilter):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            weight = 1.0
            for i in range(self.numGhosts):
                observed = self.getObservationProb(observation[i], pacmanPosition, particle[i], self.getJailPosition(i))
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            # now loop through and update each entry in newParticle...͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
            "*** YOUR CODE HERE ***"
            #raiseNotDefined()
            for i in range(self.numGhosts):
...
# One JointInference module is shared globally across instances of MarginalInference͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
