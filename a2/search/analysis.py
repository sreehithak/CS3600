...
######################
# ANALYSIS QUESTIONS #͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
######################

# Set the given parameters to obtain the specified policies through͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
# value iteration.͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
...
def question3a():
    ...
    # If not possible, return 'NOT POSSIBLE'͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
