# bustersAgents.py͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
# ----------------͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        # find likeliest positions
        for ghostBeliefs in livingGhostPositionDistributions:
            maxBelief = 0
            ghostPosition = 0
            for position, belief in ghostBeliefs.items():
                if belief > maxBelief:
                    maxBelief = belief
        ...
        # find best action using closest ghost
        closestAction = 0
        minDist2 = float("inf")
        for action in legal:
            successorPosition = Actions.getSuccessor(pacmanPosition, action)
            dist2 = self.distancer.getDistance(successorPosition, closestGhost)
            if dist2 < minDist2:
                minDist2 = dist2
