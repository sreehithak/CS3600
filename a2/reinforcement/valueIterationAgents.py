# valueIterationAgents.py͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
# -----------------------͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        # Write value iteration code here͏󠄂͏️͏󠄌͏󠄎͏󠄇͏󠄋͏󠄃
        "*** YOUR CODE HERE ***"
    ...
    def computeQValueFromValues(self, state, action):
        ...
        for nextState, prob in self.mdp.getTransitionStatesAndProbs(state, action):
            immediate = self.mdp.getReward(state, action, nextState)
            q += prob * (immediate + self.discount * self.values[nextState])
        return q
